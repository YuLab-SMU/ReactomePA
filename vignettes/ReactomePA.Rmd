...
If you use `r Biocpkg("Reactome")` in published research, please cite G. Yu (2015). In addition, please cite G. Yu (2012) when using `compareCluster` in `r Biocpkg("clusterProfiler")`, G Yu (2015) when applying enrichment analysis to NGS data using `r Biocpkg("ChIPseeker")`.

```
G Yu, QY He.
ReactomePA: an R/Bioconductor package for reactome pathway analysis and visualization
Molecular BioSystems 2015, submitted.
```
